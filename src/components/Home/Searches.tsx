...
const Searches = () => {
  ...
  return (
    <section className="w-full flex-col justify-center items-center px-4 sm:px-10 xl:px-28 py-10">
      <header>
      ...
      <section className="flex justify-between flex-wrap py-3 lg:w-[90%]">
        <div className="min-w-[16rem]">
          <h3 className="text-md md:text-xl font-medium py-3 underline">
            Dubai Apartments
          </h3>
      ...
      <section className="py-3">
        <h3 className="text-md md:text-xl font-medium py-3">
